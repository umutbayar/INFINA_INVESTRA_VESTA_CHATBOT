...
# LangChain için gerekli kütüphaneler
...
#  Ana Webhook Intent'lere Göre Sorguları İşleme
    ...
    try:
        ...
        # Grup 1: Genel Sorgular
            ...
            if not kullanici_id_param:
                ...
                # Gelen parametrenin liste olma durumu kontrol ediliyor.
                kullanici_id = int(kullanici_id_param[0] if isinstance(kullanici_id_param, list) else kullanici_id_param)
                
                # 'adet' parametresi de güvenli bir şekilde alınıyor.
                adet = None
        ...
        # Grup 3: Hem Müşteri ID'si hem de Hisse Kodu Gerektiren Sorgular
            ...
            if not konu: 
                ...
                # Önce kendi veritabanımızda bir çözüm var mı diye bakalım
